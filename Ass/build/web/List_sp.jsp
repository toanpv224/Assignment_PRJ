                ...
                <div
                    ...
                    <div class="row no-margin">
                        <div class="item-category col-sm-12 col-md-6 no-padding">
                            <a href="category?cid=${0}" class="absolute-link"></a>
                            <figure>
                                <img
                                    height="374"
                                    width="374"
                            ...
                            <div class="category-info">
                                <h4>
                                    <a href="category?cid=${0}">TẤT CẢ SẢN PHẨM</a>
                                </h4>
                        ...
                        <div class="col-sm-12 col-md-6 no-padding">
                            <div class="row no-margin">
                                <div class="item-category grid col-sm-6 no-padding">
                                    <a href="category?cid=${1}" class="absolute-link"></a>
                                    <figure>
                                        <img
                                    ...
                                    <div class="category-info">
                                        <h4><a href="category?cid=${1}">Áo Khoác</a></h4>
                                        <p>Đẹp không hồi kết</p>
                                    </div>
                                </div>

                                <div class="item-category grid col-sm-6 no-padding">
                                    <a href="category?cid=${4}" class="absolute-link"></a>
                                    <figure>
                                        <img
                                            height="374"
                                            width="374"
                                    ...
                                    <div class="category-info">
                                        <h4><a href="category?cid=${4}">Phụ kiện</a></h4>
                                        <p>Đồ linh tinh rẻ thúi</p>
                                    </div>
                                </div>

                                <div class="item-category grid col-sm-6 no-padding">
                                    <a href="category?cid=${2}" class="absolute-link"></a>
                                    <figure>
                                        <img
                                            height="374"
                                            width="374"
                                    ...
                                    <div class="category-info">
                                        <h4><a href="category?cid=${2}">Áo Thun</a></h4>
                                        <p>Áo đẹp sấm sét</p>
                                    </div>
                                </div>

                                <div class="item-category grid col-sm-6 no-padding">
                                    <a href="category?cid=${3}" class="absolute-link"></a>
                                    <figure>
                                        <img
                                            height="374"
                                            width="374"
                                    ...
                                    <div class="category-info">
                                        <h4><a href="category?cid=${3}">Quần</a></h4>
